...
CAMPOS_LISTADO_PDI = ["latitud","longitud","rangoMaximoAlcance","categoria"]
	...
	if request.method == "POST":
		...
		if success:
			...
			try:	
				...
				lista_puntos_de_interes = obtenerListadoPuntosDeInteresSearch(parametrosPeticion["latitud"],parametrosPeticion["longitud"],parametrosPeticion["rangoMaximoAlcance"],parametrosPeticion["categoria"])
